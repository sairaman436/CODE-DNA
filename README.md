...
For local development you can still use `GMAIL_USER` and `GMAIL_APP_PASSWORD`, but production Render mail should use `RESEND_API_KEY` because free Render services may not deliver SMTP traffic.
