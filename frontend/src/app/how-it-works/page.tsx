      ...
      <main className="relative z-10 pt-32 pb-24 px-6">
        ...
        <div className="max-w-4xl mx-auto mb-24">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-[11px] uppercase tracking-[0.2em] font-bold text-emerald-500/70">Documentation</span>
          </div>
              ...
              {STEPS.map((step, i) => (
                ...
                >
                  ...
                  <div className="relative flex-shrink-0 pt-8">
                    <div className="w-10 h-10 rounded-xl bg-zinc-950 border border-white/[0.06] flex items-center justify-center text-[11px] font-mono text-zinc-600 group-hover:text-emerald-500 group-hover:border-emerald-500/20 transition-all z-10 relative">
                      {step.num}
                    </div>
                  </div>
                  ...
                  <div className="py-8 border-b border-white/[0.04] flex-1">
                    <h3 className="text-[17px] font-semibold text-white mb-3 group-hover:text-emerald-400 transition-colors">{step.title}</h3>
